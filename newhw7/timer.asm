...
;              MotorEventHandler function to determine which motors to reverse,
;              which motors to turn on, and turning on/off the laser, It
...
;              controller and to timer 2, then send timer 2 to the interrupt.
;
; Arguments: None
; Return Value: None.
...
Timer2EventHandler PROC        NEAR
    ...
    CALL   SerialInterruptHandler ; figures out direction for every motor. Also
